...
rec = idwt2(rec(1:size(It_3{1},1),1:size(It_3{1},2)), [], It_3{2}, [], g0, g1); 
...
rec = idwt2(rec(1:size(It_2{1},1),1:size(It_2{1},2)), [], [], [], g0, g1); 
% LH and HL are reversed for dwt2
...
rec = idwt2(rec(1:size(It_1{1},1),1:size(It_1{1},2)), [], [], [], g0, g1); 
% LH and HL are reversed for dwt2
